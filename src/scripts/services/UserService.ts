...
class UserService {
	private API_URL: string = process.env.REACT_APP_API_URL || 'https://localhost:8000'
	...
	public createProfile(userProfile: any) {
    	...
    	return this.ConnectionMiddleware(() => this.axiosInstanceCreateProfile.post(url, userProfile))
	}
	...
	public get_or_create_private_chat(profile_id: any) {
    	const url: string = `api/get_or_create_private_chat/`
